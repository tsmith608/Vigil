...
export async function GET() {
  try {
    console.log("📥 Loading IRIDIUM TLEs from DB...");
        ...
        console.log(`📄 Retrieved ${tles.length} IRIDIUM TLE entries from DB`);
